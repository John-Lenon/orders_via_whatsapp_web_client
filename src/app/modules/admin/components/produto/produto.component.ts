...
export class ProdutoComponent extends FormBase {
  ...
  constructor() { 
    ...
    this.controlesFormulario = {
      ...
      email: {
        controle: new FormControl('', [CustomValidator.required, CustomValidator.email]),
        mensagens: {
          required: 'Esse campo é obrigatório',
      ...
      produtoEscolhido: {
        controle: new FormControl('', [CustomValidator.requiredForSingleSelectList]),
        mensagens: {
          requiredForSingleSelectList: 'Esse campo é obrigatório'
        }
      }, 
      multiplosProdutos: {
        controle: new FormControl('', [CustomValidator.requiredForMultipleSelectList]), 
        mensagens: {
  ...
  listaMultiplosProdutos: OptionToSelectList[] = [
    {
      ...
      value: new Produto('2828', 1, EnumStatusProduto.ATIVO, 23.99, 'Temaki 11', 'Temaki 11', 'teste/teste01')
    }, 
    {
      viewValue: 'Produto 02',
      value: new Produto('2222', 2, EnumStatusProduto.ATIVO, 988.99, 'Temaki 02', 'Temaki 02', 'teste/teste01')
    }, 
    {
      viewValue: 'Produto 03',
      value: new Produto('33333', 3, EnumStatusProduto.ATIVO, 1378.99, 'Temaki 03', 'Temaki 03', 'teste/teste01')
    }
  ];
  ...
  submitFormulario() : void {
    ...
    this.httpService.post<Produto, any>(novoProduto, 'produto').subscribe(() => {
      debugger
    });     
  }
}
